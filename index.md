...
Durante el curso se realizarán tres proyectos. 
...
-------- | ------------ | --------------------------------------------- |  -------------------------------------
 ...
 3       | 23.09.2025   | Diseñar un algoritmo genético o resolver el problema de programación lineal, correspondiente a un TSP o a un VRP. <br/> 
                          Las instancias que se trabajarán serán a nivel industrial. Vamos a considerar las siguientes fuentes de datos: <br/> 
